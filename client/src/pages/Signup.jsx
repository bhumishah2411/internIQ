...
import { Briefcase, Mail, Lock, User, Eye, EyeOff, Moon, Sun } from 'lucide-react';
    ...
    <div className={`min-h-screen ${theme.bg} ${theme.text} flex items-center justify-center p-4 transition-colors duration-300`}>
      ...
      <div className="w-full max-w-6xl grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className={`${theme.card} border ${theme.border} rounded-2xl shadow-2xl p-8`}>
          ...
          <p className={`${theme.textSecondary} mb-6`}>Start tracking your internship applications</p>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className={`block text-sm font-medium mb-2 ${theme.textSecondary}`}>
                Full Name
              </label>
            ...
            <div>
              <label htmlFor="confirmPassword" className={`block text-sm font-medium mb-2 ${theme.textSecondary}`}>
                Confirm Password
              </label>
              <div className={`flex items-center ${theme.input} border ${theme.border} rounded-lg px-3 py-2`}>
                <Lock className="w-5 h-5 mr-2 text-gray-400" />
